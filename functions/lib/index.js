...
exports.weeklyApproverDigest =
  exports.onRequestStatusChange =
  exports.onRequestCreated =
  exports.cleanupDeletedProjects =
  exports.downloadFileV2 =
  exports.uploadBankBookV2 =
  exports.uploadReceiptsV2 =
    void 0;
...
exports.cleanupDeletedProjects = (0, scheduler_1.onSchedule)(
  ...
  async () => {
    ...
    for (const projectDoc of snapshot.docs) {
      ...
      console.log(
        `Deleted project ${projectId}: ${requests.size} requests, ${settlements.size} settlements, ${storagePaths.length + orphanedFiles.length} files`,
      );
    }
  },
);
...
exports.onRequestStatusChange = (0, firestore_1.onDocumentUpdated)(
  ...
  async (event) => {
    ...
    const shouldNotifyRequester =
      ...
      ((oldStatus === 'pending' || oldStatus === 'reviewed') &&
        newStatus === 'rejected') ||
    ...
    try {
      ...
      console.log(
        `Status change email sent to ${requestedBy.email} (${oldStatus}→${newStatus})`,
      );
    } catch (error) {
