...
import { isStaff, canAccessDashboard, canManageUsers, canAccessReceipts, canAccessSettlement } from '../lib/roles'
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const adminItems = [
    ...
    ...(canAccessSettlement(role) ? [{ to: '/admin/settlements', label: t('nav.settlements') }] : []),
