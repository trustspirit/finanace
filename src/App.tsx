...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/admin/settlement/new', element: <ProtectedRoute requiredRoles={['admin', 'finance']}><SettlementPage /></ProtectedRoute> },
      { path: '/admin/settlements', element: <ProtectedRoute requiredRoles={['admin', 'finance']}><SettlementListPage /></ProtectedRoute> },
      { path: '/admin/settlement/:id', element: <ProtectedRoute requiredRoles={['admin', 'finance']}><SettlementReportPage /></ProtectedRoute> },
