...
| **운영위 승인자** | `approver_ops` | 운영위 검토완료 건 최종 승인/반려 |
| **준비위 재정(총괄)** | `finance_prep` | 모든 위원회 검토/반려, 정산, 승인건 반려, 영수증·대시보드·예산·사용자 관리 |
| **준비위 승인자** | `approver_prep` | 준비위 검토완료 건 최종 승인/반려 |
| **위원장** | `director` | 모든 위원회 최종 승인/반려, 대시보드, 고액 승인 |
| **관리자** | `admin` | 전체 권한 + 프로젝트 관리 |

### 권한별 기능 매트릭스

| 기능 | `user` | `finance_ops` | `approver_ops` | `finance_prep` | `approver_prep` | `director` | `admin` |
|------|:------:|:-------------:|:--------------:|:--------------:|:---------------:|:----------:|:-------:|
| 신청서 작성 | O | O | O | O | O | O | O |
| 내 신청 내역 조회 | O | O | O | O | O | O | O |
| 신청 취소 (본인) | O | O | O | O | O | O | O |
| 반려/취소 건 재신청 | O | O | O | O | O | O | O |
| **신청 관리 (목록)** | - | 운영위 | 운영위 | 전체 | 준비위 | 전체 | 전체 |
| **검토 (pending→reviewed)** | - | 운영위 | - | 전체 | - | - | 전체 |
| **반려 (pending→rejected)** | - | 운영위 | - | 전체 | - | - | 전체 |
| **최종 승인 (reviewed→approved)** | - | - | 운영위 | - | 준비위 | 전체 | 전체 |
| **최종 반려 (reviewed→rejected)** | - | - | 운영위 | - | 준비위 | 전체 | 전체 |
| 고액 승인 (>60만원) | - | - | - | - | - | O | O |
| 정산 처리 | - | - | - | O | - | - | O |
| 승인건 반려 (approved→rejected) | - | - | - | O | - | - | O |
| 영수증 관리 | - | - | - | O | - | - | O |
| 대시보드 / 예산 설정 | - | - | - | O | - | O | O |
| 사용자 관리 | - | - | - | O | - | - | O |
| 프로젝트 관리 | - | - | - | - | - | - | O |
