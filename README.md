...
| **운영위 승인자** | `approver_ops` | + 운영위원회 신청 승인/반려 |
| **준비위 승인자** | `approver_prep` | + 준비위원회 신청 승인/반려 |
| **재정담당** | `finance` | + 전체 신청 승인/반려, 정산, 영수증 관리, 대시보드, 예산 설정, 사용자 관리 |
| **위원장** | `director` | + 전체 신청 승인/반려, 대시보드, 고액 신청 승인 |
| **관리자** | `admin` | + 전체 권한, 사용자 관리, 프로젝트 관리 |

### 신청 관리 (승인자, 재정담당, 위원장, 관리자)
...
2. 전체 사용자 목록이 표시됩니다.
3. 드롭다운으로 권한을 변경할 수 있습니다 (일반/운영위 승인자/준비위 승인자/재정담당/위원장/관리자).
